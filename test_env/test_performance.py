"""Floyd-Warshall algorithm performance testing for both 
'Imperative' and 'Recursive' functions.
"""
...
# Global variable to be used in testing
matrix = [
    [0, 5, inf, 10],
    [inf, 0, 3, inf],
    [inf, inf, 0, 1],
...
"""Defining both of the imported functions 
